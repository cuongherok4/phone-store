...
@section('page_title', 'Thêm mới Mã giảm giá')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <textarea name="description" rows="2"
                              ...
                              placeholder="Mô tả ngắn gọn về chương trình...">{{ old('description') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" name="discount_value" value="{{ old('discount_value') }}" required min="0" step="any"
                ...
                <div>
                    ...
                    <input type="number" name="max_uses_per_user" value="{{ old('max_uses_per_user', 1) }}" min="1"
                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                ...
                <div class="col-span-1 md:col-span-2 mt-2">
                    <label class="flex items-center cursor-pointer">
                        ...
                        <span class="ml-2 text-gray-700 font-medium">Kích hoạt mã giảm giá ngay</span>
                    </label>
                </div>
            </div>
